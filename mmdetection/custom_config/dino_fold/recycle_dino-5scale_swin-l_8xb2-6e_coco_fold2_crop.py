...
train_dataloader = dict(
    ...
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file='kfolds/integrated_train_kfold_2.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file='kfolds/integrated_val_kfold_2.json',
        data_prefix=dict(img=''),
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'kfolds/integrated_val_kfold_2.json',
    metric='bbox',
    format_only=False,
    classwise=True,
    )
    ...
    vis_backends = [
        ...
        dict(type='WandbVisBackend',
             init_kwargs=dict(
                 ...
                 project='dino',
                 name='swin-l_5scale_original_epochs12_SR_fold2'))],
    name='visualizer'    
    )
