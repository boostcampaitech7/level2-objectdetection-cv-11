# 기본 설정 파일 로드
# C:\Users\Daehwan\Documents\9_ai_framework\mmdetection\configs\swin\retinanet_swin-t-p4-w7_fpn_1x_coco.py
# _base_ = './projects/CO-DETR/configs/codino/co_dino_5scale_r50_lsj_8xb2_1x_coco.py'
# _base_ = './configs/swin/retinanet_swin-t-p4-w7_fpn_1x_coco.py'
# _base_ = './configs/ddq/ddq-detr-4scale_swinl_8xb2-30e_coco.py'
