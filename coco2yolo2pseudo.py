...
def main():
    # 저장할 경로 입력
    save_path = '/data/ephemeral/home/ay_yolo/yolo_dataset_ay/pseudo07/labels'
    ...
    json_path = '/data/ephemeral/home/ay_yolo/train_plus_pseudo_label_07.json' #'/data/ephemeral/home/ay_yolo/pseudo_label_0.5.json' #'/home/oem/ayeong/dataset/train.json'
